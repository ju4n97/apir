...
If you find a security vulnerability in esquema, please report it privately. Don't open a public issue for security vulnerabilities.

## Supported versions

esquema follows trunk-based development and doesn't maintain previous release branches.

Security fixes are provided for the latest release. Older releases should be upgraded to the latest version.

## Reporting a vulnerability

Report vulnerabilities through [GitHub Security Advisories](https://github.com/ju4n97/esquema/security/advisories).
...
esquema doesn't operate a bug bounty program. No monetary reward is offered for security reports.

## Security model

esquema uses several defensive measures by default:
